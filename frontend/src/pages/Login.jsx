        ...
        <div className="lg:col-span-6 flex justify-center">
          <div className="w-full max-w-md bg-[#111726]/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {/* Quick Fill Pills */}
              <div className="flex items-center justify-between text-[11px] bg-slate-900/80 px-3 py-2 rounded-xl border border-slate-800/80">
                <span className="text-slate-400 font-medium flex items-center gap-1">
                  <Sparkles className="w-3 h-3 text-amber-400" /> Autofill:
                </span>
                <div className="flex gap-1.5">
                  <button
                    type="button"
                    onClick={() => setQuickFill('admin')}
                    className="px-2 py-0.5 rounded-md bg-slate-800 hover:bg-emerald-500/20 text-emerald-400 text-[10px] font-semibold border border-slate-700 transition"
                  >
                    Admin
                  </button>
                  <button
