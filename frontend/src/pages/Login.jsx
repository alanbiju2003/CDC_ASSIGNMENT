...
import { Shield, Store, Lock, Mail, ArrowRight, Sparkles, AlertCircle, CheckCircle2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#070a12] text-slate-100 flex items-center justify-center p-4 lg:p-8 relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center z-10">
        ...
        <div className="lg:col-span-6 space-y-8 p-4 lg:p-8 hidden lg:block">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center font-black text-emerald-400 text-lg">
              KV
            </div>
          ...
          <div className="grid grid-cols-3 gap-3 pt-4">
            <div className="p-3.5 rounded-2xl bg-slate-900/60 border border-slate-800 backdrop-blur-sm space-y-1">
              ...
              <p className="text-[11px] text-slate-400">Top Vendors</p>
            </div>
            <div className="p-3.5 rounded-2xl bg-slate-900/60 border border-slate-800 backdrop-blur-sm space-y-1">
              <div className="text-emerald-400 font-semibold text-xs flex items-center gap-1.5">
                <Shield className="w-4 h-4" /> Secure
              </div>
              <p className="text-[11px] text-slate-400">Encrypted JWT</p>
            </div>
            <div className="p-3.5 rounded-2xl bg-slate-900/60 border border-slate-800 backdrop-blur-sm space-y-1">
              <div className="text-emerald-400 font-semibold text-xs flex items-center gap-1.5">
                <Sparkles className="w-4 h-4 text-amber-400" /> Scale
              </div>
              <p className="text-[11px] text-slate-400">Automated Sync</p>
            </div>
          </div>
        ...
        <div className="lg:col-span-6 flex justify-center">
          <div className="w-full max-w-md bg-[#111726]/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl space-y-6">
            ...
            <div className="text-center space-y-2">
              <div className="w-14 h-14 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 p-1 mx-auto flex items-center justify-center text-emerald-400 font-bold text-2xl shadow-lg shadow-emerald-500/10">
                KV
              </div>
